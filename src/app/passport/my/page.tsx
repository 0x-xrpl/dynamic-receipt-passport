...
import { buildTestnetTxUrl, type MintedPassport } from "@/lib/xrpl";
      ...
      <div className="space-y-6">
        {stats ? (
          <>
            ...
            <div className="lift-hover shine relative overflow-hidden rounded-[1.8rem] border border-white/12 bg-white/5 p-6 text-white shadow-[0_22px_60px_rgba(4,6,16,0.65)] backdrop-blur-2xl sm:p-7">
              ...
              <div className="relative z-10 grid gap-4 sm:grid-cols-2">
                ...
                <div className="sm:col-span-2">
                  ...
                  <div className="mt-2 flex flex-wrap items-center gap-3 rounded-[1.2rem] border border-white/12 bg-white/5 px-4 py-3 font-mono text-sm text-white/90">
          ...
          <div className="lift-hover shine relative overflow-hidden rounded-[1.8rem] border border-white/12 bg-white/5 p-6 text-white shadow-[0_22px_60px_rgba(4,6,16,0.65)] backdrop-blur-2xl sm:p-8">
