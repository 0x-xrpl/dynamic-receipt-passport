        ...
        {stats ? (
          <>
            <div className="mx-auto w-[90vw] max-w-[440px]">
              <PassportCard
                ...
                variant="compact"
                size="card"
                headerLabel="Dynamic Receipt Passport"
              />
            </div>
              ...
              <div className="relative z-10 space-y-4">
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  <InfoTile
                    ...
                    value={
                      mintedPassport
                        ? shortenHash(mintedPassport.address, 8, 6)
                        : "—"
                    }
                  />
                  <InfoTile
                    ...
                    value={
                      mintedPassport
                        ? shortenHash(mintedPassport.nfTokenId, 8, 6)
                        : "—"
                    }
                  />
                </div>
                  ...
                  <div className="flex flex-wrap items-center gap-3 rounded-[1.2rem] border border-white/12 bg-white/5 px-4 py-3 font-mono text-sm text-white/90">
                    ...
                    >
                      <Link
                        href={
                          mintedPassport
                            ? buildTestnetTxUrl(mintedPassport.mintHash)
                            : "#"
                        }
                        target={mintedPassport ? "_blank" : undefined}
                        rel={mintedPassport ? "noreferrer" : undefined}
                      >
          ...
          <div className="mx-auto w-[90vw] max-w-[440px] lift-hover shine relative overflow-hidden rounded-[1.8rem] border border-white/12 bg-white/5 p-6 text-white shadow-[0_22px_60px_rgba(4,6,16,0.65)] backdrop-blur-2xl sm:p-8">
            ...
            <div className="relative z-10 space-y-4 text-center">
              <p className="text-[0.72rem] uppercase tracking-[0.32em] text-white/60">
                No passport found
              </p>
              <p className="text-lg leading-relaxed text-white/80">
                You haven&apos;t minted a Level 1 passport yet. Jump to the mint
                flow to create yours on XRPL Testnet.
              </p>
